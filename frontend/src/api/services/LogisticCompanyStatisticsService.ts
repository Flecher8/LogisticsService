...
const averageDeliveryTimeApi = "/AverageDeliveryTimeByLogisticCompany?logisticCompanyId=";
const averageDeliveryPathLengthApi = "/AverageDeliveryPathLengthByLogisticCompany?logisticCompanyId=";
const numberOfDeliveredOrdersApi = "/NumberOfDeliveredOrdersByLogisticCompany?logisticCompanyId=";
const numberOfNotDeliveredOrdersApi = "/NumberOfNotDeliveredOrdersByLogisticCompany?logisticCompanyId=";
const averageOrderPriceApi = "/AverageOrderPriceByLogisticCompany?logisticCompanyId=";

export class LogisticCompanyStatisticsService {
